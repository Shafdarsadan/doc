        ...
        children: [
          ...
          Padding(
            ...
            child: Container(
              ...
              child:
              FutureBuilder(
                future: FirebaseFirestore.instance.collection('DocCategory').get(),
               ...
               if(snapshot.hasData){
                 return GridView.builder(
                  ...
                  return _CategoryCard(category: snapshot.data!.docs[index].id,img_url:snapshot.data!.docs[index]['img'] ,);
                },);
               }else{
...
class _CategoryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    MaterialPageRoute(
    builder: (context) =>
    Booking(categoryName: category,is_video: false,)));
    },
                  child: Card(
                    ...
                    child: Column(
                      children: [
                        Container(
                            ...
                            child: Image.network(img_url,width: 50,height: 40,fit: BoxFit.cover,)),
                        Padding(
